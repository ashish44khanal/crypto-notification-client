            ...
            <div className="bg-gray-100 p-8 shadow-lg w-1/3">
                ...
                <form action="">
                    <div className="flex flex-col space-y-2 my-5">
                        ...
                        <input type="text" className="border p-3 rounded-md outline-primary-base" id='name' placeholder='Enter you full name here ' />
                    </div>
                    <div className="flex flex-col space-y-2 my-5">
                    ...
                    <div className="flex flex-col space-y-2 my-5">
                        <input type="submit" className="bg-primary-base text-white px-4 py-2 rounded-md w-fit font-bold cursor-pointer" value="SIGNUP" />
                    </div>
